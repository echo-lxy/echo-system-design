---
title: EventLoop 源码解析
date: 2024-09-18 21:10:31
permalink: /pages/397456/
---
...
![image-20240918231355627](https://echo798.oss-cn-shenzhen.aliyuncs.com/img/202409182313683.png)
...
![image-20240918231415729](https://echo798.oss-cn-shenzhen.aliyuncs.com/img/202409182314772.png)
...
![image-20240918231501360](https://echo798.oss-cn-shenzhen.aliyuncs.com/img/202409182315401.png)
...
[![Alt text](https://echo798.oss-cn-shenzhen.aliyuncs.com/img/202409182148955.png)](https://github.com/yongshun/learn_netty_source_code/blob/master/Netty 源码分析之 三 我就是大名鼎鼎的 EventLoop/NioEventLoopGroup.png)
...
![image-20240918231744626](https://echo798.oss-cn-shenzhen.aliyuncs.com/img/202409182317683.png)
...
[![Alt text](https://echo798.oss-cn-shenzhen.aliyuncs.com/img/202409182148122.png)](https://github.com/yongshun/learn_netty_source_code/blob/master/Netty 源码分析之 三 我就是大名鼎鼎的 EventLoop/NioEventLoop.png) 
...
![image-20240918231917515](https://echo798.oss-cn-shenzhen.aliyuncs.com/img/202409182319590.png)
...
![NioEventLoop 与 Channel 的关联过程(1)](https://echo798.oss-cn-shenzhen.aliyuncs.com/img/202409182325791.png)
...
我们已经分析过了, **inEventLoop == false**, 因此执行到 else 分支, 在这里就调用了 **startThread()** 方法来启动 SingleThreadEventExecutor 内部关联的 Java 本地线程了. 总结一句话, 当 EventLoop.execute **第一次被调用**时, 就会触发 **startThread()** 的调用, 进而导致了 EventLoop 所对应的 Java 线程的启动. 我们将 **EventLoop 与 Channel 的关联** 小节中的时序图补全后, 就得到了 EventLoop 启动过程的时序图: 

![NioEventLoop 的启动过程(1)](https://echo798.oss-cn-shenzhen.aliyuncs.com/img/202409182330761.png)
