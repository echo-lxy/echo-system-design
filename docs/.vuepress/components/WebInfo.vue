<template>
  ...
  <div class="web-info card-box">
    ...
    <div v-if="indexView" class="webinfo-item">
      ...
      <div class="webinfo-content">
        <span id="busuanzi_value_site_pv" class="web-site-pv"><i title="正在获取..." class="loading iconfont icon-loading"></i>
        </span>
        次
      </div>
    </div>
    ...
    <div v-if="indexView" class="webinfo-item">
      ...
      <div class="webinfo-content busuanzi">
        <span id="busuanzi_value_site_uv" class="web-site-uv"><i title="正在获取..." class="loading iconfont icon-loading"></i>
        </span>
        名
      </div>
    </div>
